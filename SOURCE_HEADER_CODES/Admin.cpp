...
int Admin::add_students()  // Adds / Removes Students from IITH .
{
    ...
    ifstream newone("../TEXT_FILES/DATABASE.txt");
    ...
    case 2:
    {
        ...
        ifstream in("../TEXT_FILES/DATABASE.txt", ios::in);
        ...
        {
            ifstream in1("../TEXT_FILES/student_courses.txt", ios::in);
...
int Admin::add_courses()  //  Adds / Removes courses from IITH .
{
    ...
    ifstream cour("../TEXT_FILES/courses.txt");
    ...
    case 2:
    {
        ...
        {
            ifstream in("../TEXT_FILES/courses.txt", ios::in);
...
int Admin::view_courses()  // View the courses present at IITH .
{
    ...
    case 1:
    {
        ...
        if (checking_course(line) == 0)
        {
            ifstream inte("../TEXT_FILES/courses.txt", ios::in);
