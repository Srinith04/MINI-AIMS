...
{
    ifstream checking("../TEXT_FILES/student_courses.txt");
    string w1, w2;
...
{
    ifstream check_1("../TEXT_FILES/student_courses.txt");
...
int Student::add_courses_sub(int opt, const string &I)
{
    ...
    case 1:
    {
        int a;
        k++;
        ifstream newone("../TEXT_FILES/courses.txt");
        while (newone >> a)
        {
            getline(newone, line);
            if (a == 1)
        ...
        l = 1;
                        #ifdef _WIN32 
                    system("cls"); // Executes the "clear" command
                #else
                    system("clear"); // Executes the "cls" command
                #endif
        break;
    }
    case 2:
    {
        ...
        ofstream newfilepointer("../TEXT_FILES/student_courses.txt", ios::app);
        ifstream check("../TEXT_FILES/courses.txt");
    ...
    case 3:
    {
        ...
        ifstream in("../TEXT_FILES/student_courses.txt", ios::in);
